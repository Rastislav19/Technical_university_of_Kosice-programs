...
export default function processOpnFrmData(event){
    ...
    const nopMail = document.getElementById("e-mail").value.trim();
    const nopOp = document.getElementById("opinion").value.trim();
    const nopKey= document.getElementById("key").value.trim();
